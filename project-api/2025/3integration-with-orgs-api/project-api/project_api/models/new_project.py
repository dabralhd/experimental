...
class NewProject(Model):
    ...
    """
    def __init__(self, project_name_to_clone: str=None, ai_project_name: str=None, ai_project_type: str=None, description: str=None, reference: str=None, version: str=None, creation_time: str=None, last_update_time: str=None):  # noqa: E501
