...
static const char *const lsm6dsv16x_mlc_date = "2025-03-26 16:01:20";
...
static const struct mems_conf_result lsm6dsv16x_mlc_results_0_0[] = {
	{ .code = 0x00, .label = "sitting" },
	{ .code = 0x04, .label = "standing" },
	{ .code = 0x08, .label = "running" },
	{ .code = 0x0C, .label = "walking" }
};
...
static const struct mems_conf_mlc_identifier lsm6dsv16x_mlc_mlc_identifiers_0[] = {
	{ .fifo_tag = 0x1B, .id = 0x03CC, .label = "FILTER_IIR2_ACC_V" },
	{ .fifo_tag = 0x1C, .id = 0x03CE, .label = "F1_MAXIMUM_ACC_Y" },
	{ .fifo_tag = 0x1C, .id = 0x03D0, .label = "F2_MEAN_ACC_Y" },
	{ .fifo_tag = 0x1C, .id = 0x03D2, .label = "F3_ABS_MEAN_ACC_V" },
	{ .fifo_tag = 0x1C, .id = 0x03D4, .label = "F4_MINIMUM_ACC_Y" },
	{ .fifo_tag = 0x1C, .id = 0x03D6, .label = "F5_PEAK_TO_PEAK_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x03D8, .label = "F6_ENERGY_ACC_Y" },
	{ .fifo_tag = 0x1C, .id = 0x03DA, .label = "F7_VARIANCE_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x03DC, .label = "F8_MAXIMUM_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x03DE, .label = "F9_MINIMUM_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x03E0, .label = "F10_ABS_MINIMUM_ACC_V" },
	{ .fifo_tag = 0x1C, .id = 0x03E2, .label = "F11_ABS_VARIANCE_ACC_V_FILTER_1" },
	{ .fifo_tag = 0x1C, .id = 0x03E4, .label = "F12_ABS_ENERGY_ACC_V_FILTER_1" },
	{ .fifo_tag = 0x1C, .id = 0x03E6, .label = "F13_ABS_PEAK_TO_PEAK_ACC_V_FILTER_1" },
	{ .fifo_tag = 0x1C, .id = 0x03E8, .label = "F14_ABS_MAXIMUM_ACC_V_FILTER_1" },
	{ .fifo_tag = 0x1C, .id = 0x03EA, .label = "F15_ABS_MINIMUM_ACC_V_FILTER_1" }
};
