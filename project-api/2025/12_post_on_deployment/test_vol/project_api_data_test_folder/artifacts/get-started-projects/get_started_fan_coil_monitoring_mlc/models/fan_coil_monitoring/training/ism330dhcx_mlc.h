...
static const char *const ism330dhcx_mlc_date = "2025-03-26 15:48:52";
...
static const struct mems_conf_mlc_identifier ism330dhcx_mlc_mlc_identifiers_0[] = {
	{ .fifo_tag = 0x1B, .id = 0x039A, .label = "FILTER_IIR2_ACC_V" },
	{ .fifo_tag = 0x1C, .id = 0x039C, .label = "F1_MEAN_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x039E, .label = "F2_VARIANCE_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x03A0, .label = "F3_ENERGY_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x03A2, .label = "F4_PEAK_TO_PEAK_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x03A4, .label = "F5_MINIMUM_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x03A6, .label = "F6_MAXIMUM_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x03A8, .label = "F7_MEAN_ACC_Y" },
	{ .fifo_tag = 0x1C, .id = 0x03AA, .label = "F8_MINIMUM_ACC_Y" },
	{ .fifo_tag = 0x1C, .id = 0x03AC, .label = "F9_MAXIMUM_ACC_Y" },
	{ .fifo_tag = 0x1C, .id = 0x03AE, .label = "F10_ENERGY_ACC_Z" },
	{ .fifo_tag = 0x1C, .id = 0x03B0, .label = "F11_ABS_MEAN_ACC_V" },
	{ .fifo_tag = 0x1C, .id = 0x03B2, .label = "F12_ABS_ENERGY_ACC_V" },
	{ .fifo_tag = 0x1C, .id = 0x03B4, .label = "F13_ABS_MEAN_ACC_V_FILTER_1" }
};
