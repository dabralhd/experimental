...
static const char *const ism330dhcx_mlc_date = "2025-03-26 15:40:16";
...
static const struct mems_conf_mlc_identifier ism330dhcx_mlc_mlc_identifiers_0[] = {
	{ .fifo_tag = 0x1B, .id = 0x03AC, .label = "FILTER_IIR2_ACC_X" },
	{ .fifo_tag = 0x1B, .id = 0x03AE, .label = "FILTER_IIR2_ACC_Y" },
	{ .fifo_tag = 0x1B, .id = 0x03B0, .label = "FILTER_IIR2_ACC_Z" },
	{ .fifo_tag = 0x1C, .id = 0x03B2, .label = "F1_ENERGY_ACC_Y" },
	{ .fifo_tag = 0x1C, .id = 0x03B4, .label = "F2_PEAK_TO_PEAK_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x03B6, .label = "F3_MAXIMUM_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x03B8, .label = "F4_VARIANCE_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x03BA, .label = "F5_MINIMUM_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x03BC, .label = "F6_MEAN_ACC_Z" },
	{ .fifo_tag = 0x1C, .id = 0x03BE, .label = "F7_ENERGY_ACC_Z" },
	{ .fifo_tag = 0x1C, .id = 0x03C0, .label = "F8_ABS_MEAN_ACC_V" },
	{ .fifo_tag = 0x1C, .id = 0x03C2, .label = "F9_ENERGY_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x03C4, .label = "F10_MEAN_ACC_X" },
	{ .fifo_tag = 0x1C, .id = 0x03C6, .label = "F11_MAXIMUM_ACC_Y_FILTER_1" },
	{ .fifo_tag = 0x1C, .id = 0x03C8, .label = "F12_ENERGY_ACC_Y_FILTER_1" },
	{ .fifo_tag = 0x1C, .id = 0x03CA, .label = "F13_VARIANCE_ACC_Z_FILTER_1" },
	{ .fifo_tag = 0x1C, .id = 0x03CC, .label = "F14_PEAK_TO_PEAK_ACC_Z_FILTER_1" },
	{ .fifo_tag = 0x1C, .id = 0x03CE, .label = "F15_ENERGY_ACC_Z_FILTER_1" }
};
