 ...
 * Project id:
 * Model name: tennis_activity_recognition_320x
 * Model id:
 */
...
#ifndef LSM6DSV320X_MLC_H
#define LSM6DSV320X_MLC_H
...
#define LSM6DSV320X_MLC_SENSORS_NUM 1
...
static const char *const lsm6dsv320x_mlc_format_version = "2.0";

static const char *const lsm6dsv320x_mlc_description = "Generated sensor configuration for MLC core";

static const struct mems_conf_application lsm6dsv320x_mlc_application = {
	.name = "MLC Tool",
	.version = "2.3.0"
};

static const char *const lsm6dsv320x_mlc_date = "2025-09-15 16:51:25";

/* Sensor names */

static const char *const lsm6dsv320x_mlc_names_0[] = {
	"LSM6DSV320X"
};

static const struct mems_conf_name_list lsm6dsv320x_mlc_name_lists[LSM6DSV320X_MLC_SENSORS_NUM] = {
	{ .list = lsm6dsv320x_mlc_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv320x_mlc_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsv320x_mlc_conf_0[] = {
...
static const struct mems_conf_op_list lsm6dsv320x_mlc_confs[LSM6DSV320X_MLC_SENSORS_NUM] = {
	{ .list = lsm6dsv320x_mlc_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsv320x_mlc_conf_0) }
};

/* Outputs */

static const struct mems_conf_result lsm6dsv320x_mlc_results_0_0[] = {
...
static const struct mems_conf_output lsm6dsv320x_mlc_outputs_0[] = {
	{
		...
		.reg_addr = 0x70,
		.reg_name = "MLC1_SRC",
		.num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(lsm6dsv320x_mlc_results_0_0),
		.results = lsm6dsv320x_mlc_results_0_0
	}
};

static const struct mems_conf_output_list lsm6dsv320x_mlc_output_lists[LSM6DSV320X_MLC_SENSORS_NUM] = {
	{ .list = lsm6dsv320x_mlc_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv320x_mlc_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier lsm6dsv320x_mlc_mlc_identifiers_0[] = {
	{ .fifo_tag = 0x1C, .id = 0x03C8, .label = "F1_MEAN_GYR_X" },
	{ .fifo_tag = 0x1C, .id = 0x03CA, .label = "F2_MAXIMUM_GYR_X" },
	{ .fifo_tag = 0x1C, .id = 0x03CC, .label = "F3_MEAN_ACCHG_Z" },
	{ .fifo_tag = 0x1C, .id = 0x03CE, .label = "F4_VARIANCE_ACCHG_Y" },
	{ .fifo_tag = 0x1C, .id = 0x03D0, .label = "F5_ABS_MEAN_GYR_V" },
	{ .fifo_tag = 0x1C, .id = 0x03D2, .label = "F6_MEAN_ACC_Z" },
	{ .fifo_tag = 0x1C, .id = 0x03D4, .label = "F7_MAXIMUM_GYR_Y" },
	{ .fifo_tag = 0x1C, .id = 0x03D6, .label = "F8_ABS_MAXIMUM_GYR_V" },
	{ .fifo_tag = 0x1C, .id = 0x03D8, .label = "F9_VARIANCE_GYR_Y" },
	{ .fifo_tag = 0x1C, .id = 0x03DA, .label = "F10_ENERGY_GYR_Z" },
	{ .fifo_tag = 0x1C, .id = 0x03DC, .label = "F11_VARIANCE_GYR_Z" },
	{ .fifo_tag = 0x1C, .id = 0x03DE, .label = "F12_MEAN_ACCHG_X" },
	{ .fifo_tag = 0x1C, .id = 0x03E0, .label = "F13_VARIANCE_ACC_Y" },
	{ .fifo_tag = 0x1C, .id = 0x03E2, .label = "F14_ENERGY_ACCHG_X" },
	{ .fifo_tag = 0x1C, .id = 0x03E4, .label = "F15_MEAN_GYR_Z" }
};

static const struct mems_conf_mlc_identifier_list lsm6dsv320x_mlc_mlc_identifier_lists[LSM6DSV320X_MLC_SENSORS_NUM] = {
	{ .list = lsm6dsv320x_mlc_mlc_identifiers_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv320x_mlc_mlc_identifiers_0) }
};
