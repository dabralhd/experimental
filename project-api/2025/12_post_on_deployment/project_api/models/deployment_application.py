...
from project_api.models.bluest_v3_payload import Bluest_V3_Payload  # noqa: F401,E501
...
class DeploymentApplication(Model):
    ...
    """
    def __init__(self, uuid: str=None, type: str=None, device_template_uri: str=None, device_template_id: str=None, device_manifest_uri: str=None, image_uri: str=None, module_id: str=None, binary_uri: str=None, binary_id: int=None, protocol: int=None, bluest_v3_payload: Bluest_V3_Payload=None):  # noqa: E501
        ...
        :type protocol: int
        :param bluest_v3_payload: The bluest_v3_payload of this DeploymentApplication.  # noqa: E501
        :type bluest_v3_payload: Bluest_V3_Payload
        """
        self.swagger_types = {
            'uuid': str,
            'type': str,
            ...
            'binary_id': int,
            'protocol': int,
            'bluest_v3_payload': Bluest_V3_Payload
        }
        ...
        self._bluest_v3_payload = bluest_v3_payload.to_dict() if bluest_v3_payload else None
    ...
    def bluest_v3_payload(self) -> Bluest_V3_Payload:
        """Gets the bluest_v3_payload of this DeploymentApplication.


        :return: The bluest_v3_payload of this DeploymentApplication.
    ...
    def bluest_v3_payload(self, bluest_v3_payload: Bluest_V3_Payload):
        """Sets the bluest_v3_payload of this DeploymentApplication.


        :param bluest_v3_payload: The bluest_v3_payload of this DeploymentApplication.
        :type bluest_v3_payload: Bluest_V3_Payload
        """
