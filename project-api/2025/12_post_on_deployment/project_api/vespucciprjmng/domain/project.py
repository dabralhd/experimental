...
class Project(DomainOBJ):
    ...
    def project_owner_uuid(self, value: str):
        self.__project_owner_uuid = value        

    def __init__(self, uuid: str = None, name: str = None, type: str = None, description: str = None, version: str = None, models: List[Model] = [], applications: List[Application] = [], deployments: List[Deployment] = [], display_name: str = None, project_owner_uuid: str = None):
        self.__uuid         = uuid
        self.__name         = name
        self.__type         = type
