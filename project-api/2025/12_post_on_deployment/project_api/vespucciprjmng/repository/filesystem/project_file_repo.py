...
class ProjectFileRepo(ProjectRepo):
    ...
    def create_deployment(self, project_name: str, deployment_name: str, description: str=None, cloud_type: str=None, cloud_app_url: str=None,
        ...
        for leaf in leaf_devices:
            ...
            for app in getattr(leaf.inference, 'supported_applications', []):
                inference_supported_applications.append(app)
            logger.debug(f'ProjectFileRepo.create_deployment: leaf-inference-supported_applications: {inference_supported_applications}')

            datalogging_supported_applications = []
            for app in getattr(leaf.datalogging, 'supported_applications', []):
                datalogging_supported_applications.append(app)
            logger.debug(f'ProjectFileRepo.create_deployment: leaf-datalogging-supported_applications: {datalogging_supported_applications}')
            ...
            _leaf = Device(gateway_id=leaf.gateway_id, 
                            ...
                            inference_supported_applications=inference_supported_applications,
                            datalogging_supported_applications=datalogging_supported_applications
                            )
        ...
        for leaf in new_deployment.leaf_devices:
            logger.debug(f'ProjectFileRepo.create_deployment: leaf-datalogging-supported_applications: {leaf.datalogging_supported_applications}')
            logger.debug(f'ProjectFileRepo.create_deployment: leaf-inference-supported_applications: {leaf.inference_supported_applications}')
            
        logger.debug(f"ProjectFileRepo.create_deployment: deployment saved: new_deployment: {new_deployment}")
