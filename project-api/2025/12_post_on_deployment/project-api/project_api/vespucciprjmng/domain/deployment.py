...
class Device():
    ...
    def supported_applications(self) -> List[str]:
        return self.__supported_applications
    
    @supported_applications.setter 
    def supported_applications(self, value: List[str]):
        self.__supported_applications = value
    ...
    def __init__(self, 
        ...
        self.__supported_applications: List[str] = supported_applications if supported_applications is not None else []
