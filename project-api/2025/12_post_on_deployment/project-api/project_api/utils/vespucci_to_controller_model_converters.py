...
def convert_deployment (deploy : VespucciDeployment):
    ...
    for lf in deploy.leaf_devices:
        #inference_supported_applications = [y for y in lf.get('inference').get('supported_applications')]
        #dtlg_supported_applications = [y for y in lf.get('datalogging').get('supported_applications')]
