...
def app_get_training(user: str, project_name: str, model_name: str):  # noqa: E501
    ...
    logger.info(f'project_owner_uuid: {get_project_owner_uuid(user, project_name)}')
    logger.info(f'model_owner_uuid: {get_model_owner_uuid(user, project_name, model_name)}')
