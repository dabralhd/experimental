...
def app_create_activity_configuration(body, project_name, model_name, activity_type, as_org=None):  # noqa: E501
...
def app_patch_activity_configuration(body, project_name, model_name, activity_type, as_org=None):  # noqa: E501
