...
class NewModel(Model):
    ...
    """
    def __init__(self, model_name_to_clone: str=None, name: str=None, model_type: ModelType=None, dataset: Dataset=None, classes: List[str]=None, model_target: ModelTarget=None, creation_time: str=None, last_update_time: str=None):  # noqa: E501
