...
class ProjectFileRepo(ProjectRepo):
    ...
    def create_project(self, name: str, type: str="", description: str = "", version: str = "0.0.1", uuid = None) -> Project:
        ...
        new_project = Project(uuid=uuid, name=name, type=type, description=description, version=version)
    ...
    def create_deployment(self, project_name: str, deployment_name: str, description: str=None, cloud_type: str=None, cloud_app_url: str=None,
        ...
        for existing_deployment in existing_deployments:
            if existing_deployment.display_name == deployment_name:
                raise ResourceAlreadyExisting(existing_deployment.uuid, existing_deployment.display_name, ResourceKind.MODEL)
