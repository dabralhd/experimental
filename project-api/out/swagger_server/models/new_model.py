...
class NewModel(Model):
    ...
    """
    def __init__(self, model_name_to_clone: str=None, name: str=None, model_type: ModelType=None, dataset: Dataset=None, classes: List[str]=None, training_type: TrainingType=None, target: Target=None, creation_time: str=None, last_update_time: str=None, owner_uuid: str=None):  # noqa: E501
        ...
        :param owner_uuid: The owner_uuid of this NewModel.  # noqa: E501
        :type owner_uuid: str
        """
        self.swagger_types = {
