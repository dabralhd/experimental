...
class Model(Model):
    ...
    """
    def __init__(self, dataset: Dataset=None, target: Target=None, uuid: str=None, name: str=None, metadata: ModelModelMetadata=None, training: Training=None, creation_time: str=None, last_update_time: str=None, owner_uuid: str=None):  # noqa: E501
        ...
        :param owner_uuid: The owner_uuid of this Model.  # noqa: E501
        :type owner_uuid: str
        """
        self.swagger_types = {
            'dataset': Dataset,
