...
class Project(Model):
    ...
    """
    def __init__(self, uuid: str=None, ai_project_name: str=None, display_name: str=None, description: str=None, reference: str=None, version: str=None, creation_time: str=None, last_update_time: str=None, models: List[Model]=None, deployments: List[Deployment]=None):  # noqa: E501
