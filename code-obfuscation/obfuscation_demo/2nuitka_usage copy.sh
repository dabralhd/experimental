...
poetry run python -m python_minifier --remove-literal-statements --remove-asserts "$cp_file_name" > "obfuscated_$cp_file_name"

echo "Obfuscation complete. The obfuscated file is obfuscated_$cp_file_name"