...
class ModelsApi:
    ...
    @validate_call
    def app_create_model(
        self,
        project_name: Annotated[str, Field(min_length=1, strict=True, description="Project `name` identifier")],
        new_model: Annotated[NewModel, Field(description="The model to be added (or cloned).")],
        as_org: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True)]], Field(description="sometimes a user will copy a model, using rights of an organization ")] = None,
        ...
        :param new_model: The model to be added (or cloned). (required)
        :type new_model: NewModel
        ...
        _param = self._app_create_model_serialize(
    ...
    @validate_call
    def app_create_model_with_http_info(
        self,
        project_name: Annotated[str, Field(min_length=1, strict=True, description="Project `name` identifier")],
        new_model: Annotated[NewModel, Field(description="The model to be added (or cloned).")],
        as_org: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True)]], Field(description="sometimes a user will copy a model, using rights of an organization ")] = None,
    ...
    @validate_call
    def app_create_model_without_preload_content(
        self,
        project_name: Annotated[str, Field(min_length=1, strict=True, description="Project `name` identifier")],
        new_model: Annotated[NewModel, Field(description="The model to be added (or cloned).")],
        as_org: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True)]], Field(description="sometimes a user will copy a model, using rights of an organization ")] = None,
    ...
    def _app_create_model_serialize(
        self,
        project_name,
        new_model,
        as_org,
    ...
    def app_patch_model(
        ...
        new_model: Annotated[NewModel, Field(description="The model to be patched.")],
        ...
        :type model_name: str
        :param new_model: The model to be patched. (required)
        :type new_model: NewModel
        ...
        _param = self._app_patch_model_serialize(
            project_name=project_name,
    ...
    @validate_call
    def app_patch_model_with_http_info(
        self,
        project_name: Annotated[str, Field(min_length=1, strict=True, description="Project `name` identifier")],
        model_name: Annotated[str, Field(min_length=1, strict=True, description="Model `name` identifier")],
        new_model: Annotated[NewModel, Field(description="The model to be patched.")],
    ...
    @validate_call
    def app_patch_model_without_preload_content(
        self,
        project_name: Annotated[str, Field(min_length=1, strict=True, description="Project `name` identifier")],
        model_name: Annotated[str, Field(min_length=1, strict=True, description="Model `name` identifier")],
        new_model: Annotated[NewModel, Field(description="The model to be patched.")],
    ...
    def _app_patch_model_serialize(
        self,
        project_name,
        model_name,
        new_model,
