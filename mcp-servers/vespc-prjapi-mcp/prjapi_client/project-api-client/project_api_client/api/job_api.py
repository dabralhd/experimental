...
class JobApi:
    ...
    @validate_call
    def app_create_job_for_activity(
        self,
        ...
        job: Annotated[Job, Field(description="The activity to be added.")],
        ...
        :param job: The activity to be added. (required)
        :type job: Job
        ...
        _param = self._app_create_job_for_activity_serialize(
    ...
    @validate_call
    def app_create_job_for_activity_with_http_info(
        self,
        project_name: Annotated[str, Field(min_length=1, strict=True, description="Project `name` identifier")],
        model_name: Annotated[str, Field(min_length=1, strict=True, description="Model `name` identifier")],
        activity_type: Annotated[str, Field(min_length=1, strict=True, description="Activity `name` identifier")],
    ...
    @validate_call
    def app_create_job_for_activity_without_preload_content(
        self,
        project_name: Annotated[str, Field(min_length=1, strict=True, description="Project `name` identifier")],
        model_name: Annotated[str, Field(min_length=1, strict=True, description="Model `name` identifier")],
        activity_type: Annotated[str, Field(min_length=1, strict=True, description="Activity `name` identifier")],
    ...
    def _app_create_job_for_activity_serialize(
        self,
        project_name,
        model_name,
        activity_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/projects/{project_name}/models/{model_name}/{activity_type}/job',
