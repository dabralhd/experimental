...
class PublicProjectsActivityApi:
    ...
    @validate_call
    def app_get_public_projects_activity(
        self,
        ...
        activity_type: Annotated[str, Field(min_length=1, strict=True, description="Model `activity_type` identifier")],
        ...
        :type model_name: str
        :param activity_type: Model `activity_type` identifier (required)
        ...
        _param = self._app_get_public_projects_activity_serialize(
    ...
    @validate_call
    def app_get_public_projects_activity_with_http_info(
        self,
        project_name: Annotated[str, Field(min_length=1, strict=True, description="Project `name` identifier")],
        model_name: Annotated[str, Field(min_length=1, strict=True, description="Model `name` identifier")],
        activity_type: Annotated[str, Field(min_length=1, strict=True, description="Model `activity_type` identifier")],
    ...
    @validate_call
    def app_get_public_projects_activity_without_preload_content(
        self,
        project_name: Annotated[str, Field(min_length=1, strict=True, description="Project `name` identifier")],
        model_name: Annotated[str, Field(min_length=1, strict=True, description="Model `name` identifier")],
        activity_type: Annotated[str, Field(min_length=1, strict=True, description="Model `activity_type` identifier")],
    ...
    def _app_get_public_projects_activity_serialize(
        self,
        project_name,
        model_name,
        activity_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/templates/projects/{project_name}/models/{model_name}/{activity_type}',
