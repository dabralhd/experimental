...
class AppCreateDeploymentIdRequestDeploymentLeafInnerInference(BaseModel):
    """
    AppCreateDeploymentIdRequestDeploymentLeafInnerInference
    """ # noqa: E501
    application: Optional[StrictStr] = None
    firmware_update: Optional[StrictBool] = None
    models: Optional[List[AppCreateDeploymentIdRequestDeploymentLeafInnerInferenceModelsInner]] = None
    __properties: ClassVar[List[str]] = ["application", "firmware_update", "models"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "firmware_update": obj.get("firmware_update"),
            "models": [AppCreateDeploymentIdRequestDeploymentLeafInnerInferenceModelsInner.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None
        })
        return _obj
