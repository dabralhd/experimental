...
class Target(BaseModel):
    ...
    component: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    device: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    __properties: ClassVar[List[str]] = ["type", "component", "device"]
    ...
    def component_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
