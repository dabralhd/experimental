...
class AppCreateDeploymentIdRequestDeploymentLeafInnerInferenceModelsInner(BaseModel):
    """
    ...
    model_name_reference: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["artifact_type", "component_name", "model_name_reference"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "model_name_reference": obj.get("model_name_reference")
        })
        return _obj
