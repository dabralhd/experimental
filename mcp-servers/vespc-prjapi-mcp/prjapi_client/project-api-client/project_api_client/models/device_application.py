...
class DeviceApplication(BaseModel):
    ...
    protocol: Optional[Union[StrictFloat, StrictInt]] = None
    firmware_uri: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["device_template_uri", "device_template_id", "protocol", "firmware_uri"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "firmware_uri": obj.get("firmware_uri")
        })
        return _obj
