...
class DeviceModelsInner(BaseModel):
    """
    DeviceModelsInner
    """ # noqa: E501
    name: Optional[StrictStr] = None
    datalogging: Optional[DeviceApplication] = None
    inference: Optional[DeviceApplication] = None
    __properties: ClassVar[List[str]] = ["name", "datalogging", "inference"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "datalogging": DeviceApplication.from_dict(obj["datalogging"]) if obj.get("datalogging") is not None else None,
            "inference": DeviceApplication.from_dict(obj["inference"]) if obj.get("inference") is not None else None
        })
        return _obj
