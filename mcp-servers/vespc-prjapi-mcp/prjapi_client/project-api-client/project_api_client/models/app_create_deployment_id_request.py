...
class AppCreateDeploymentIdRequest(BaseModel):
    """
    AppCreateDeploymentIdRequest
    """ # noqa: E501
    applications: List[AppCreateDeploymentIdRequestApplicationsInner]
    deployment: AppCreateDeploymentIdRequestDeployment
    __properties: ClassVar[List[str]] = ["applications", "deployment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applications": [AppCreateDeploymentIdRequestApplicationsInner.from_dict(_item) for _item in obj["applications"]] if obj.get("applications") is not None else None,
            "deployment": AppCreateDeploymentIdRequestDeployment.from_dict(obj["deployment"]) if obj.get("deployment") is not None else None
        })
        return _obj
