...
class EFSUsage(BaseModel):
    """
    EFSUsage
    """ # noqa: E501
    efs_usage_breached: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["efs_usage_breached"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "efs_usage_breached": obj.get("efs_usage_breached")
        })
        return _obj
