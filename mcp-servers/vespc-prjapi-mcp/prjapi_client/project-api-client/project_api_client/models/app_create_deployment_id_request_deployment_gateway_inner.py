...
class AppCreateDeploymentIdRequestDeploymentGatewayInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["application", "description", "display_name", "device_id", "wifi_mode"]
