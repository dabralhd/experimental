...
class UpdateDevice(BaseModel):
    ...
    UpdateDevice
    """ # noqa: E501
    cloud_credentials: Optional[UpdateDeviceCloudCredentials] = None
    __properties: ClassVar[List[str]] = ["cloud_credentials"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cloud_credentials": UpdateDeviceCloudCredentials.from_dict(obj["cloud_credentials"]) if obj.get("cloud_credentials") is not None else None
        })
        return _obj
