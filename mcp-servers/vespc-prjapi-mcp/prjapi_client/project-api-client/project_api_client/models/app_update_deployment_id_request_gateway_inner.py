...
class AppUpdateDeploymentIdRequestGatewayInner(BaseModel):
    """
    AppUpdateDeploymentIdRequestGatewayInner
    """ # noqa: E501
    device_id: Optional[StrictStr] = Field(default=None, alias="_device_id")
    device_id: Optional[StrictStr] = None
    application: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    display_name: Optional[StrictStr] = None
    wifi_mode: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_device_id", "device_id", "application", "description", "display_name", "wifi_mode"]
