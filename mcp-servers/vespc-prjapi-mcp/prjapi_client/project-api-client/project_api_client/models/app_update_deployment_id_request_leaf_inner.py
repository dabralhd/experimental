...
class AppUpdateDeploymentIdRequestLeafInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_device_id", "device_id", "gateway_id", "description", "display_name", "datalogging", "inference"]
